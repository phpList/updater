...
if (isset($_POST['action'])) {
        ...
        <style>
            ...
            */
            ...
            li::before {
                ...
                padding-right: 8px;
                color: #4B8CCA; /* Or a color you prefer */
            }
    ...
    <div id="center">
        <div id="logo" title="Go back to phpList dashboard" onclick="location.href='../admin';">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="175" height="54.598" viewBox="0 0 175 54.598">
                <defs>
                    <linearGradient id="linear-gradient" x1="0.763" y1="0.237" x2="0.257" y2="0.745" gradientUnits="objectBoundingBox">
                    ...
                    <linearGradient id="linear-gradient-2" x1="0.236" y1="0.778" x2="0.717" y2="0.294" gradientUnits="objectBoundingBox">
                        <stop offset="0" stop-color="#fff"/>
                        <stop offset="0.15" stop-color="#fbfcfc"/>
                    ...
                    <g id="Artwork_3-2" data-name="Artwork 3" transform="translate(-87.5 -27.299)">
                        <g id="Group_343" data-name="Group 343" transform="translate(62.756 10.828)">
                            <g id="Group_342" data-name="Group 342" transform="translate(106.498)">
                                <path id="Path_799" data-name="Path 799" d="M541.063,41.334v-.413a1.175,1.175,0,0,0-.064-.444.571.571,0,0,0-.286-.286h0a.6.6,0,0,0,.349-.54.762.762,0,0,0-.286-.635,1.333,1.333,0,0,0-.825-.222H539v2.825h.444V40.381h.6a.6.6,0,0,1,.413.127.54.54,0,0,1,.127.413,4.921,4.921,0,0,0,.032.54v.1h.476v-.19Zm-.444-1.778a.381.381,0,0,1-.19.317.921.921,0,0,1-.476.127h-.508V39.08h.54a.825.825,0,0,1,.476.127A.445.445,0,0,1,540.619,39.556Z" transform="translate(-537.159 -37.306)" fill="#243746"/>
                                <path id="Path_800" data-name="Path 800" d="M538.564,35.5a2.73,2.73,0,0,0-1.048-1.016,2.952,2.952,0,0,0-2.889,0,2.73,2.73,0,0,0-1.048,1.016,2.825,2.825,0,0,0,1.048,3.873,2.952,2.952,0,0,0,2.889,0,2.825,2.825,0,0,0,1.048-3.873Zm-2.476,3.873a2.444,2.444,0,0,1-1.27-.349,2.381,2.381,0,0,1-.889-.889,2.445,2.445,0,0,1-.317-1.206,2.413,2.413,0,0,1,.317-1.238,2.349,2.349,0,0,1,.889-.889,2.476,2.476,0,0,1,1.238-.317,2.444,2.444,0,0,1,1.27.349,2.381,2.381,0,0,1,.889.889,2.476,2.476,0,0,1,0,2.412,2.381,2.381,0,0,1-.889.889,2.444,2.444,0,0,1-1.238.349Z" transform="translate(-533.2 -34.111)" fill="#243746"/>
                            </g>
                            <path id="Path_801" data-name="Path 801" d="M274.011,50.491a7.072,7.072,0,0,1,1.809,5.269v9.079h-4.6v-8.38a4.208,4.208,0,0,0-.825-2.825,2.9,2.9,0,0,0-2.381-.921,3.65,3.65,0,0,0-2.762,1.079A4.432,4.432,0,0,0,264.2,57v7.841h-4.6V47.6a4.6,4.6,0,0,1,4.6-4.6h0v7.618a6.126,6.126,0,0,1,2.222-1.4,8,8,0,0,1,2.825-.508A6.5,6.5,0,0,1,274.011,50.491Z" transform="translate(-239.951 -40.178)" fill="#243746"/>
                            <path id="Path_806" data-name="Path 806" d="M215.032,68.457a8.634,8.634,0,0,0-1.048-4.285,7.3,7.3,0,0,0-2.857-2.857A8.1,8.1,0,0,0,207.1,60.3a6.109,6.109,0,0,0-4.984,2.063V60.3a4.6,4.6,0,0,0-4.412,4.635v17.2h4.6V74.71a6.179,6.179,0,0,0,4.793,1.9,8.094,8.094,0,0,0,4.031-1.016,7.3,7.3,0,0,0,2.857-2.857,8.634,8.634,0,0,0,1.048-4.285Zm-12.761,0h0a3.873,3.873,0,0,1,4.031-3.968,4,4,0,0,1,2.92,1.111,3.619,3.619,0,0,1,1.079,2.1,6.188,6.188,0,0,1,.063.7,4.1,4.1,0,0,1-1.111,2.92A4.022,4.022,0,0,1,202.3,68.52Z" transform="translate(-197.7 -51.985)" fill="#243746"/>
                            <path id="Path_807" data-name="Path 807" d="M514.988,66.8a2.952,2.952,0,0,1-1.873.6,1.9,1.9,0,0,1-1.46-.54,2.159,2.159,0,0,1-.508-1.555V59.623h3.714a3.555,3.555,0,0,0-1.047-2.508h0a3.968,3.968,0,0,0-2.666-1.016h0l.1-4h-4.6l-.1,4h-.667a1.778,1.778,0,1,0,0,3.555h.667v5.682A5.555,5.555,0,0,0,508.1,69.59a6.154,6.154,0,0,0,4.381,1.46,8.476,8.476,0,0,0,2.1-.254,4.761,4.761,0,0,0,1.682-.762Z" transform="translate(-406.839 -46.39)" fill="#243746"/>
                        </g>
                        <g id="Group_345" data-name="Group 345">
                            <circle id="Ellipse_63" data-name="Ellipse 63" cx="27.299" cy="27.299" r="27.299" fill="#243746"/>
                            <path id="Path_808" data-name="Path 808" d="M41.283,40.462l2.666-2.635.222-.222a6.953,6.953,0,0,0,.667-.794,7.364,7.364,0,1,0-12.126-.349,6.158,6.158,0,0,0,.825,1.079l.317.317,2.6,2.6-5.65,5.555L12.9,28.146A27.711,27.711,0,0,0,11,31.034L28.363,48.4l-2.571,2.539-.381.381a7.237,7.237,0,0,0-2,4.6h0a6.912,6.912,0,0,0,1.238,4.508,7.364,7.364,0,0,0,13.078-1.778,6.285,6.285,0,0,0,.349-2.7,7.364,7.364,0,0,0-2.127-4.825l-2.762-2.762,5.682-5.523L56.742,60.714a27.139,27.139,0,0,0,1.873-2.92ZM33.538,53.6a3.968,3.968,0,1,1-5.714.127l.286-.317,2.635-2.6Zm2.444-18.411a3.968,3.968,0,1,1,5.777.1l-.127.127L38.87,38.081Z" transform="translate(-7.508 -17.131)" fill="#fff"/>
                            <g id="Group_344" data-name="Group 344" transform="translate(18.062 18.189)">
                                <path id="Path_809" data-name="Path 809" d="M104.006,59.712l-.127.1-2.666,2.635L98.8,60.062l2.73-2.7.063-.063Z" transform="translate(-85.5 -57.3)" fill="url(#linear-gradient)"/>
                                <path id="Path_810" data-name="Path 810" d="M62.074,100.844l-2.635,2.571-.159.127L56.9,101.162l.222-.222L59.693,98.4Z" transform="translate(-56.9 -85.354)" fill="url(#linear-gradient-2)"/>
                            </g>
                        </g>
                    </g>
                </g>
            ...
            <h1 style="font-family: 'Montserrat', Regular;font-size: 18px;">Updating phpList to the latest version</h1>
        </div>
        <div id="steps">
            ...
            <div class="step">
                <div class="step-image active">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="27.483" height="25.403" viewBox="0 0 27.483 25.403">
            ...
            <div class="step">
                <div class="step-image">
                    <svg xmlns="http://www.w3.org/2000/svg" width="23.015" height="21.33" viewBox="0 0 23.015 21.33">
                        <g id="download" transform="translate(0 0)">
                            <g id="Group_210" data-name="Group 210">
                                <path id="Path_211" data-name="Path 211" d="M22.356,228.248a.657.657,0,0,0-.659.659v6a2.959,2.959,0,0,1-2.955,2.955H4.274a2.959,2.959,0,0,1-2.955-2.955v-6.1a.659.659,0,0,0-1.319,0v6.1a4.278,4.278,0,0,0,4.274,4.274H18.741a4.278,4.278,0,0,0,4.274-4.274v-6A.66.66,0,0,0,22.356,228.248Z" transform="translate(0 -217.849)" fill="#253746"/>
                                <path id="Path_212" data-name="Path 212" d="M140.615,33.344a.664.664,0,0,0,.464.2.643.643,0,0,0,.464-.2l4.191-4.191a.66.66,0,1,0-.933-.933l-3.062,3.067V17.909a.659.659,0,1,0-1.319,0V31.288l-3.067-3.067a.66.66,0,0,0-.933.933Z" transform="translate(-129.571 -17.25)" fill="#253746"/>
                            </g>
                        </g>
                    </svg>
                </div>
            ...
            <div class="step last-step">
                <div class="step-image">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22.512" height="16.01" viewBox="0 0 22.512 16.01">
                        <path id="Path_219" data-name="Path 219" d="M16100.607-997.888c-2.889,2.889-14.332,14.2-14.332,14.2l-6.68-6.679" transform="translate(-16078.847 998.638)" fill="none" stroke="#253746" stroke-linecap="round" stroke-width="1.5"/>
                    </svg>
        ...
        <div id="display">
            ...
            <span id="success-message">Updater is loading.<br/>
             There is a new update available!</span><br>
        ...
        <div id="footer_updater" align="center">
            <div class="option-heading"></div>
            <div class="option-content is-hidden">
                <div class="featured-properties">
                    <div class="properties">
                        <div class="property">
                            <p class="hide">The Final Upgrade?</p>
                            <p class="migrate">Migrate to phpList.com and forget about the tech</p>

                            <ul>
                                <li>Seamless background updating</li>
                                <li>Managed DMARC, SPF, and DKIM</li>
                                <li>Database import for existing data</li>
                            </ul>
                        </div>
                        ...
                        <div class="property">
                            <ul>
                                ...
                                <li>Scale up to 30 million messages per month</li>
                                <li>Custom domains and unlimited users</li>
                            </ul>
                        </div>

                        <div class="property">
                            <a href="https://phplist.com/chooseplan"><img src="book_img.png" alt="book_img" width="200px"/></a>
                        </div>
                    </div><!-- end .properties -->
    ...
    <script>
        $(function ($) { // DOM ready and $ alias in scope

            /**
             * Option dropdowns. Slide toggle
             */
            $(".option-heading").on('click', function () {
                $(this).toggleClass('is-active').next(".option-content").stop().slideToggle(800);
