...
if (isset($_POST['action'])) {
    ...
    <div id="center">
        ...
        <div id="display">
            ...
            <span id="success-message">Updater is loading.
                ...
                <div id="right">
                    <div id="sqr">
                        <div class="container">
                            ...
                            <br>
                            <input type="button" onclick="location.href='https://phplist.com/chooseplan';" value="Book" style="width: 90px;height: 30px; border: 1px dashed #21AE8A; background: #fff; margin: 0 auto;" class="book" />
                        </div>
